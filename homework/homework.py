...
"""
Esta función procesa directamente los archivos csv.zip ubicados en la carpeta
files/input/, limpia y transforma la información, y genera tres archivos csv:
client.csv, campaign.csv y economics.csv, los cuales se almacenan en files/output/.
"""
...
def clean_campaign_data():
    """
    Limpia los datos de la campaña de marketing del banco:
    - Lee directamente los archivos CSV comprimidos (ZIP) de files/input/.
    - Genera tres archivos CSV (client.csv, campaign.csv, economics.csv) en files/output/.
    
    Transformaciones:
      client.csv:
        - job: se remueven los puntos y se reemplazan los guiones por guiones bajos.
        - education: se convierte a minúsculas, se reemplaza el punto por guión bajo y se cambia "unknown" por pd.NA.
        - credit_default y mortgage: se asigna 1 si el valor es "yes", y 0 en otro caso.
      
      campaign.csv:
        - Se utiliza la columna "previous_campaign_contacts" (con 'campaign' correctamente escrito).
        - previous_outcome: "success" se transforma a 1; cualquier otro valor a 0.
        - campaign_outcome: "yes" se transforma a 1; cualquier otro valor a 0.
        - Se crea la columna last_contact_date en formato "YYYY-MM-DD" combinando el día y el mes (convertido a número) con el año 2022.
      
      economics.csv:
        - Se seleccionan las columnas: client_id, cons_price_idx, euribor_three_months.
    """
